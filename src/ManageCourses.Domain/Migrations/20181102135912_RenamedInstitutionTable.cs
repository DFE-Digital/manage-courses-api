...
namespace GovUk.Education.ManageCourses.Domain.Migrations
{
    public partial class RenamedInstitutionTable : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            sqlBuilder.AppendLine("ALTER INDEX \"IX_institution_inst_code\" RENAME TO \"IX_institution_provider_code\";");
            sqlBuilder.AppendLine("ALTER INDEX \"IX_ucas_institution_inst_code\" RENAME TO \"IX_provider_provider_code\";");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            sqlBuilder.AppendLine("ALTER INDEX \"IX_institution_provider_code\" RENAME TO \"IX_institution_inst_code\";");
            sqlBuilder.AppendLine("ALTER INDEX \"IX_provider_provider_code\" RENAME TO \"IX_ucas_institution_inst_code\";");
