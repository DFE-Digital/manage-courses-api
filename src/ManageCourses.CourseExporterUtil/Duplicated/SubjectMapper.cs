...
namespace GovUk.Education.ManageCourses.CourseExporterUtil.Duplicated
{
    public class SubjectMapper
    {
        ...
        {            
            ...
            {
                throw new ArgumentException($"found unsupported subject name: {string.Join(",", ucasSubjects.Intersect(ucasUnexpected))}");
            }            
