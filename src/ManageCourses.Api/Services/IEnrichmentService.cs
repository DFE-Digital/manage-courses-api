...
namespace GovUk.Education.ManageCourses.Api.Services
{
    public interface IEnrichmentService
    {
        ...
        UcasCourseEnrichmentGetModel GetCourseEnrichment(string instCode, string ucasCourseCode);
        ...
        IList<UcasCourseEnrichmentGetModel> GetCourseEnrichmentMetadata(string instCode);
    }
}
