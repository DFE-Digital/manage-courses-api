...
git fetch --unshallow
git push --force https://\$bat-$env-manage-courses-api-app:$password@bat-$env-manage-courses-api-app.scm.azurewebsites.net:443/bat-$env-manage-courses-api-app.git HEAD:refs/heads/master
