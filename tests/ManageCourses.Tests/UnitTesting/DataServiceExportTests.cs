...
namespace GovUk.Education.ManageCourses.Tests.UnitTesting
{
    ...
    class DataServiceExportTests
    {
        ...
        [Test]
        public void GetOrganisationsForUses_should_return_multiple_ucasCodes()
        {
            var result = _sut.GetOrganisationsForUser(TestHelper.UserWithMultipleOrganisationUcasCodesEmail);
        ...
        {
            var result = _sut.GetCoursesForUserOrganisation(TestHelper.OrgWithProviderEmail, TestHelper.OrgUcasCodeWithProviders);
        ...
        {
            var result = _sut.GetCoursesForUserOrganisation(email, TestHelper.OrgUcasCodeWithProviders);
        ...
        {
            var result = _sut.GetCoursesForUserOrganisation(TestHelper.OrgWithNoProviderEmail, TestHelper.OrgUcasCodeNoProviders);
